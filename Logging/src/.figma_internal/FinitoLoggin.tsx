import svgPaths from "./svg-mkfck6m8qu";
...
function X() {
  return (
    <div className="absolute right-3.5 size-5 top-3.5" data-name="x">
...
function CtaPrimaire() {
  return (
    <div className="h-[52px] relative rounded-[20px] shrink-0 w-full" data-name="CTA Primaire">
...
export default function FinitoLoggin() {
  return (
