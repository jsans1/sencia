import svgPaths from "./svg-mk27dt2qly";
  ...
  return (
    <div className="backdrop-blur-[2px] backdrop-filter bg-white box-border content-stretch flex gap-2.5 items-center justify-center px-[17px] py-[13px] relative rounded-[50px] shrink-0">
      ...
      <div className="font-['SF_Pro_Display:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[16px] text-black text-center text-nowrap">
        <p className="leading-[normal] whitespace-pre">Maux de tête inhabituels</p>
      </div>
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="backdrop-blur-[2px] backdrop-filter bg-white box-border content-center flex flex-wrap gap-2.5 items-center justify-center px-[17px] py-[13px] relative rounded-[50px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[rgba(194,194,194,0.55)] border-solid inset-0 pointer-events-none rounded-[50px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.02)]" />
      <div className="font-['SF_Pro_Display:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[16px] text-black text-center text-nowrap">
        <p className="leading-[normal] whitespace-pre">Vertiges</p>
      </div>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="backdrop-blur-[2px] backdrop-filter bg-white box-border content-center flex flex-wrap gap-2.5 items-center justify-center px-[17px] py-[13px] relative rounded-[50px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[rgba(194,194,194,0.55)] border-solid inset-0 pointer-events-none rounded-[50px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.02)]" />
      <div className="font-['SF_Pro_Display:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[16px] text-black text-center text-nowrap">
        <p className="leading-[normal] whitespace-pre">Tension dans la nuque ou poitrine</p>
      </div>
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="backdrop-blur-[2px] backdrop-filter bg-white box-border content-center flex flex-wrap gap-2.5 items-center justify-center px-[17px] py-[13px] relative rounded-[50px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[rgba(194,194,194,0.55)] border-solid inset-0 pointer-events-none rounded-[50px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.02)]" />
      <div className="font-['SF_Pro_Display:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[16px] text-black text-center text-nowrap">
        <p className="leading-[normal] whitespace-pre">Bourdonnements d’oreille</p>
      </div>
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="backdrop-blur-[2px] backdrop-filter bg-white box-border content-stretch flex gap-2.5 items-center justify-center px-[17px] py-[13px] relative rounded-[50px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[rgba(194,194,194,0.55)] border-solid inset-0 pointer-events-none rounded-[50px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.02)]" />
      <div className="font-['SF_Pro_Display:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[16px] text-black text-center text-nowrap">
        <p className="leading-[normal] whitespace-pre">Palpitations</p>
      </div>
    </div>
  );
}
...
function Inputfield() {
  return (
    <button className="box-border content-stretch cursor-pointer flex flex-col items-start justify-start overflow-visible p-0 relative shrink-0 w-full" data-name="Inputfield">
      <Background1 />
      <Textfield />
    </button>
  );
...
export default function Logging1Ressenti() {
  return (
