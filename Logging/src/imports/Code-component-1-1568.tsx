import svgPaths from "./svg-g35vm78wdb";
  ...
  return (
    <div className="content-stretch flex flex-col gap-2 items-start justify-start leading-[0] not-italic relative shrink-0 w-full">
      ...
      <div className="font-['SF_Pro_Display:Regular',_sans-serif] relative shrink-0 text-[#7a7a7a] text-[14px] w-full">
        <p className="leading-[normal]">Sélectionnez les symptômes que vous avez ressenti aujourd’hui.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="backdrop-blur-[2px] backdrop-filter bg-white box-border content-stretch flex gap-2.5 items-center justify-center px-[17px] py-[13px] relative rounded-[50px] shrink-0">
      ...
      <div className="font-['SF_Pro_Display:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[16px] text-black text-center text-nowrap">
        <p className="leading-[normal] whitespace-pre">Aliments salés (charcuterie, plats préparés…)</p>
      </div>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="backdrop-blur-[2px] backdrop-filter bg-white box-border content-center flex flex-wrap gap-2.5 items-center justify-center px-[17px] py-[13px] relative rounded-[50px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[rgba(194,194,194,0.55)] border-solid inset-0 pointer-events-none rounded-[50px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.02)]" />
      <div className="font-['SF_Pro_Display:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[16px] text-black text-center text-nowrap">
        <p className="leading-[normal] whitespace-pre">Alcool</p>
      </div>
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="backdrop-blur-[2px] backdrop-filter bg-white box-border content-center flex flex-wrap gap-2.5 items-center justify-center px-[17px] py-[13px] relative rounded-[50px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[rgba(194,194,194,0.55)] border-solid inset-0 pointer-events-none rounded-[50px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.02)]" />
      <div className="font-['SF_Pro_Display:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[16px] text-black text-center text-nowrap">
        <p className="leading-[normal] whitespace-pre">Café ou boissons énergisantes</p>
      </div>
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="backdrop-blur-[2px] backdrop-filter bg-white box-border content-stretch flex gap-2.5 items-center justify-center px-[17px] py-[13px] relative rounded-[50px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[rgba(194,194,194,0.55)] border-solid inset-0 pointer-events-none rounded-[50px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.02)]" />
      <div className="font-['SF_Pro_Display:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[16px] text-black text-center text-nowrap">
        <p className="leading-[normal] whitespace-pre">Aucun de ces éléments</p>
      </div>
    </div>
  );
}
...
function Frame6068() {
  return <div className="h-[17px] shrink-0 w-16" />;
}
...
function Background1() {
  return (
    <div className="absolute bg-white inset-0 rounded-[84px]" data-name="Background">
      <div aria-hidden="true" className="absolute border border-[#e4e4e4] border-solid inset-0 pointer-events-none rounded-[84px]" />
    </div>
  );
}

function AnimatedCursor() {
  return <div className="h-full shrink-0 w-0.5" data-name="Animated Cursor" />;
}
    ...
    <div className="relative shrink-0 w-full" data-name="Textfield">
      <div className="flex flex-row items-center overflow-clip relative size-full">
        <div className="box-border content-stretch flex items-center justify-start px-4 py-2 relative w-full">
          <div className="absolute font-['SF_Pro_Display:Regular',_sans-serif] leading-[0] left-4 not-italic overflow-ellipsis overflow-hidden text-[#bcbcbc] text-[14px] text-nowrap" style={{ top: "calc(50% - 12px)" }}>
            <p className="leading-[24px] overflow-ellipsis overflow-hidden whitespace-pre">Stress, changements d’humeur...</p>
          </div>
...
function Inputfield() {
  return (
    <div className="content-stretch cursor-pointer flex flex-col items-start justify-start relative shrink-0 w-full" data-name="Inputfield" role="button" tabIndex="0">
      <Background1 />
      <Textfield />
    </div>
  );
...
export default function Logging5Consommation() {
  return (
    <button className="bg-white block cursor-pointer overflow-clip relative rounded-[44px] size-full" data-name="Logging5-consommation">
      <BgLinear />
      <HomeBar />
      <Frame32 />
      <Frame6155 />
