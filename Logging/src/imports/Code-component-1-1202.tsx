import svgPaths from "./svg-ro456j84dg";
...
function Background1() {
  return (
    <div className="absolute bg-white inset-0 rounded-[84px]" data-name="Background">
      <div aria-hidden="true" className="absolute border border-[rgba(228,228,228,0.55)] border-solid inset-0 pointer-events-none rounded-[84px]" />
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full" data-name="Textfield">
      <div className="flex flex-row items-center overflow-clip relative size-full">
        <div className="box-border content-stretch flex items-center justify-start px-4 py-2 relative w-full">
          <div className="font-['SF_Pro_Display:Regular',_sans-serif] leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#bcbcbc] text-[14px] text-nowrap">
            <p className="leading-[24px] overflow-ellipsis overflow-hidden whitespace-pre">ex : 140 mmHg</p>
          </div>
        </div>
      </div>
    </div>
...
function Inputfield() {
  return (
    <button className="box-border content-stretch cursor-pointer flex flex-col items-start justify-start overflow-visible p-0 relative shrink-0 w-[120px]" data-name="Inputfield">
      <Background1 />
      <Textfield />
    </button>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Textfield">
      <div className="flex flex-row items-center overflow-clip relative size-full">
        <div className="box-border content-stretch flex items-center justify-start px-4 py-2 relative w-full">
          <div className="font-['SF_Pro_Display:Regular',_sans-serif] leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#bcbcbc] text-[14px] text-nowrap">
            <p className="leading-[24px] overflow-ellipsis overflow-hidden whitespace-pre">ex : 90 mmHg</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame6073() {
  return (
    <div className="content-stretch flex gap-3 items-center justify-start relative shrink-0 w-full">
      <FileText />
      <div className="font-['SF_Pro_Display:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#a0a0a0] text-[18px] text-center text-nowrap">
        <p className="leading-[normal] whitespace-pre">Notes...</p>
      </div>
    </div>
  );
}
