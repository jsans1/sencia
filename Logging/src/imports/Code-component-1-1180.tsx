import svgPaths from "./svg-9lf3uce22o";
...
function Slide() {
  return <div className="bg-gradient-to-r from-[#62ffa4] h-[38px] rounded-[80px] to-[#ff5d5d] via-[#ffb48b] via-[51.923%] w-[327px]" data-name="slide" />;
}
...
export default function Logging1Ressenti() {
  return (
    <div className="bg-white overflow-clip relative rounded-[44px] size-full" data-name="Logging1-ressenti">
      ...
      <HomeBar />
      <Frame6077 />
      <div className="absolute flex h-[327px] items-center justify-center left-[177px] top-[330px] w-[38px]">
        <div className="flex-none rotate-[90deg]">
          <Slide />
        </div>
      </div>
      <div className="absolute flex h-[32px] items-center justify-center left-[180px] top-[346px] w-[32px]">
        <div className="flex-none rotate-[90deg]">
          <div className="bg-white rounded-[16px] size-8" />
        </div>
      </div>
