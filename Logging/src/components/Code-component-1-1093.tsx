...
import svgPaths from "../imports/svg-49qcuxj5fc";

interface PhysicalActivityScreenProps {
  initialValue: 'yes_30_plus' | 'yes_30_minus' | 'no' | null;
  onBack: () => void;
  onContinue: (value: 'yes_30_plus' | 'yes_30_minus' | 'no' | null) => void;
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-2 items-start justify-start leading-[0] not-italic relative shrink-0 w-full">
      <div className="font-['SF_Pro_Display:Medium',_sans-serif] relative shrink-0 text-[26px] text-black w-full">
        <p className="leading-[1.1]">Avez-vous été physiquement actif(ve) aujourd'hui ?</p>
      </div>
...
interface ActivityDialProps {
  value: 'yes_30_plus' | 'yes_30_minus' | 'no' | null;
  onChange: (value: 'yes_30_plus' | 'yes_30_minus' | 'no' | null) => void;
}

function ActivityDial({ value, onChange }: ActivityDialProps) {
  ...
  const getValueFromAngle = useCallback((angle: number) => {
    ...
    // 315° - 45° (top): yes_30_plus
    // 45° - 135° (right): yes_30_minus  
    // 225° - 315° (bottom): no
  ...
  const getAngleFromValue = useCallback((val: 'yes_30_plus' | 'yes_30_minus' | 'no' | null) => {
    if (val === 'yes_30_plus') return 0; // Top
    if (val === 'yes_30_minus') return 90; // Right
    if (val === 'no') return 270; // Bottom
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Roue">
      ...
      {/* Labels */}
      <div className="[grid-area:1_/_1] font-['SF_Pro_Display:Semibold',_sans-serif] ml-[87px] mt-[98px] not-italic relative text-[16px] text-black text-center translate-x-[-50%] w-[92px]">
      ...
      <div className="[grid-area:1_/_1] font-['SF_Pro_Display:Semibold',_sans-serif] ml-[253px] mt-[98px] not-italic relative text-[16px] text-black text-center translate-x-[-50%] w-[92px]">
        <p className="leading-[normal]">
          Oui,
          <br aria-hidden="true" />
          - de 30 mins
      ...
      <div className="[grid-area:1_/_1] font-['SF_Pro_Display:Semibold',_sans-serif] ml-[170px] mt-[250px] not-italic relative text-[16px] text-black text-center translate-x-[-50%] w-[92px]">
...
export function PhysicalActivityScreen({ initialValue, onBack, onContinue }: PhysicalActivityScreenProps) {
  const [activityValue, setActivityValue] = useState<'yes_30_plus' | 'yes_30_minus' | 'no' | null>(initialValue);

  const handleContinue = () => {
    onContinue(activityValue);
  };

  return (
    <div className="bg-white overflow-clip relative rounded-[44px] size-full" data-name="Logging6-activités physiques">
      <BgLinear />
      <HomeBar />
        ...
        <div className="relative shrink-0 w-full">
          <div className="flex flex-col items-center justify-center relative size-full">
            <div className="box-border content-stretch flex flex-col gap-[50px] items-center justify-center px-[30px] py-10 relative w-full">
              ...
              <ActivityDial value={activityValue} onChange={setActivityValue} />
            </div>
          </div>
        </div>
      </div>
