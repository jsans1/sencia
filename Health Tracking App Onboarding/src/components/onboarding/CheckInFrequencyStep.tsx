    ...
    <div className="bg-white relative size-full" data-name="V2- Care Plan">
      ...
      <div className="absolute content-stretch flex flex-col gap-4 items-center justify-start left-4 top-[727px] w-[361px]">
        <button
          ...
          className="bg-[#212121] h-[53px] relative rounded-[20px] shrink-0 w-full cursor-pointer"
        >
          ...
          <div className="flex flex-row items-center justify-center relative size-full">
            <div className="box-border content-stretch flex gap-2.5 h-[53px] items-center justify-center px-5 py-4 relative w-full">
              <span className="font-['SF_Pro_Display:Medium',_sans-serif] leading-[0] not-italic text-[18px] text-center text-nowrap text-white">
                Continuer
              </span>
            </div>
          </div>
        ...
        <button 
          onClick={handleSkip}
          className="font-['SF_Pro_Display:Regular',_sans-serif] leading-[0] not-italic text-[#636363] text-[14px] text-center w-full cursor-pointer"
        >
          Plus tard
        </button>
      </div>
