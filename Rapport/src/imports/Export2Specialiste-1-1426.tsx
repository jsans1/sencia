import svgPaths from "./svg-ejy37zvlt";
...
function CtaPrimaire() {
  return (
    <div className="bg-gradient-to-r box-border content-stretch flex from-[#a69bf8] gap-2.5 items-center justify-center px-5 py-4 relative rounded-[20px] shadow-[0px_-4px_15.4px_0px_rgba(0,0,0,0.06)] shrink-0 to-[#0e7afe] w-[361px]" data-name="CTA Primaire">
