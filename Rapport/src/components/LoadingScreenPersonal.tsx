...
import svgPaths from "../imports/svg-1ifjht9dw9";

interface LoadingScreenPersonalProps {
  onComplete: () => void;
}
...
export default function LoadingScreenPersonal({ onComplete }: LoadingScreenPersonalProps) {
  useEffect(() => {
