import svgPaths from "../imports/svg-q4rr4xdnr6";

interface ChoixDeLexportPersoProps {
  onBack: () => void;
  onClose: () => void;
  onContinue: () => void;
}
...
function CtaPrimaire({ onClick }: { onClick: () => void }) {
  return (
    <button 
      onClick={onClick}
      className="absolute bg-[#212121] box-border content-stretch flex gap-2.5 items-center justify-center left-4 px-5 py-4 rounded-[20px] top-[756px] w-[361px] cursor-pointer hover:opacity-90 transition-opacity" 
...
function Medicament() {
  return (
    <div className="basis-0 bg-white grow h-[116px] min-h-px min-w-px relative rounded-[10px] shrink-0" data-name="médicament">
      <div aria-hidden="true" className="absolute border border-[#e4e4e4] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <div className="flex flex-row items-center justify-center relative size-full">
        <div className="box-border content-stretch flex gap-2.5 h-[116px] items-center justify-center px-4 py-2.5 relative w-full">
          <div className="basis-0 font-['SF_Pro_Display:Regular',_sans-serif] grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#636363] text-[16px] text-center">
...
function Medicament1() {
  return (
    <div className="basis-0 bg-white grow h-[116px] min-h-px min-w-px relative rounded-[10px] shrink-0" data-name="médicament">
      <div aria-hidden="true" className="absolute border border-[#a69bf8] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <div className="flex flex-row items-center justify-center relative size-full">
        <div className="box-border content-stretch flex gap-2.5 h-[116px] items-center justify-center px-3.5 py-2.5 relative w-full">
          <div className="basis-0 bg-clip-text bg-gradient-to-r font-['SF_Pro_Display:Bold',_sans-serif] from-[#a69bf8] grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[16px] text-center to-[#0e7afe]" style={{ WebkitTextFillColor: "transparent" }}>
...
export default function ChoixDeLexportPerso({ onBack, onClose, onContinue }: ChoixDeLexportPersoProps) {
  return (
    <div className="bg-white overflow-clip relative rounded-[44px] size-full" data-name="choix de l\'export - perso">
      <BgLinear />
      <HomeBar />
      <CtaPrimaire onClick={onContinue} />
