import svgPaths from "./svg-vs8whw9wr6";
...
export default function HomepageNoLog() {
  return (
    <button className="bg-white block cursor-pointer overflow-clip relative rounded-[44px] size-full" data-name="Homepage_no log">
      <BgLinear />
      <ProgressBar />
