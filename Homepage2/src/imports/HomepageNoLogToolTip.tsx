import svgPaths from "./svg-eib6n4vvyr";
    ...
    <div className="content-stretch flex flex-col gap-3 items-start justify-center leading-[0] not-italic relative shrink-0 text-center w-full">
      <div className="bg-clip-text bg-gradient-to-r font-['SF_Pro_Display:Bold',_sans-serif] from-[#a69bf8] relative shrink-0 text-[32px] to-[#0e7afe] w-full" style={{ WebkitTextFillColor: "transparent" }}>
        <p className="leading-[1.16]">
          <span className="text-[#212121]">Comment te sens-tu ce matin,</span>
          <span>{` Loris ?`}</span>
        </p>
      </div>
...
function Plus() {
  return (
    <div className="relative shrink-0 size-[31.819px]" data-name="plus">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="plus">
          <path d="M15.9098 6.62908V25.1902" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.60812" />
          <path d="M6.62959 15.9095H25.1907" id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.60812" />
        </g>
      </svg>
    </div>
  );
...
function Frame6101() {
  return (
    <div className="bg-[#292929] h-[67.31px] relative rounded-[312.974px] shrink-0 w-full">
      <div className="flex flex-row items-center justify-center relative size-full">
        <div className="box-border content-stretch flex gap-[6.364px] h-[67.31px] items-center justify-center p-[24.182px] relative w-full">
          <Plus />
        </div>
      </div>
    </div>
...
function Frame6187() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[9.79px] items-center justify-start top-1/2 translate-x-[-50%] translate-y-[-50%] w-[67.309px]" style={{ left: "calc(50% + 0.612px)" }}>
      <Frame6101 />
      <div className="font-['SF_Pro_Display:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#606060] text-[14px] text-center w-full">
        <p className="leading-[1.2]">Check-in</p>
      </div>
    </div>
  );
}
    ...
    <div className="content-stretch flex items-start justify-start relative shrink-0">
      <div className="flex items-center justify-center relative shrink-0">
        <div className="flex-none rotate-[180deg] scale-y-[-100%]">
          <div className="h-[257px] relative w-[128.5px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 129 257">
              <path d={svgPaths.p3b331180} fill="url(#paint0_linear_1_502)" id="Ellipse 1499" />
              <defs>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_502" x1="3.86151e-06" x2="4.28334" y1="257" y2="7.99429e-07">
      ...
      <div className="h-[257px] relative shrink-0 w-[128.5px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 129 257">
          <path d={svgPaths.p3b331180} fill="var(--fill-0, white)" id="Ellipse 1497" />
        </svg>
      </div>
      <Frame6187 />
    </div>
...
function HelpCircle() {
  return (
    <div className="relative shrink-0 size-[16.5px]" data-name="help-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 17">
        <g id="help-circle">
          <path d={svgPaths.p22d0e100} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.375" />
          <path d={svgPaths.p21fec280} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.375" />
          <path d="M8.25 11.6874H8.2575" id="Vector_3" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.375" />
        </g>
      </svg>
    </div>
  );
...
function Feature4() {
  return (
    <div className="bg-gradient-to-r box-border content-stretch flex from-[#a69bf8] gap-[7.5px] items-center justify-center p-[6px] relative rounded-[15px] shrink-0 size-[30px] to-[#0e7afe]" data-name="feature-4">
      <HelpCircle />
    </div>
  );
}
...
function Frame6189() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <div className="font-['SF_Pro_Display:Bold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#212121] text-[18px] text-nowrap">
        <p className="leading-[1.2] whitespace-pre">À quoi ça sert ?</p>
      </div>
      <Feature4 />
    </div>
  );
...
function Frame6188() {
  return (
    <div className="content-stretch flex flex-col gap-3 items-start justify-center relative shrink-0 w-full">
      <Frame6189 />
      <div className="font-['SF_Pro_Display:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#606060] text-[13px] w-full">
        <p className="leading-[1.2]">Ça t’aidera à avoir des informations précise sur ton état de santé afin de mieux le comprendre et pouvoir en parler aisément à ton médecin traitant !</p>
      </div>
    </div>
  );
}
...
function Frame6190() {
  return (
    <div className="absolute content-stretch flex flex-col gap-10 items-center justify-start left-1/2 translate-x-[-50%] translate-y-[-50%] w-[327px]" style={{ top: "calc(50% - 11.5px)" }}>
      <Frame6150 />
      <Frame6186 />
      <Frame6076 />
    </div>
  ...
  return (
    <div className="relative shrink-0 size-6" data-name="home">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="home">
          <path d={svgPaths.p3039c600} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M9 22V12H15V22" id="Vector_2" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Frame6102() {
  return (
    <div className="content-stretch flex flex-col gap-[7px] items-center justify-center relative shrink-0 w-[45px]">
      <Home />
      <div className="font-['SF_Pro_Display:Medium',_sans-serif] leading-[0] not-italic relative shrink-0 text-[14px] text-black text-nowrap">
...
function Frame6103() {
  return (
    <div className="content-stretch flex flex-col gap-[7px] items-center justify-center relative shrink-0 w-[45px]">
      <Compass />
      <div className="font-['SF_Pro_Display:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#a19f9e] text-[14px] text-nowrap">
...
function Frame6191() {
  return (
    <div className="content-stretch flex flex-col gap-2.5 items-start justify-center leading-[0] not-italic relative shrink-0 w-full">
      <div className="font-['SF_Pro_Display:Bold',_sans-serif] relative shrink-0 text-[#212121] text-[16px] w-[159px]">
        <p className="leading-[1.2]">Effectue ton Check-in</p>
      </div>
      <div className="font-['SF_Pro_Display:Regular',_sans-serif] min-w-full relative shrink-0 text-[#606060] text-[12px]" style={{ width: "min-content" }}>
        <p className="leading-[1.2]">Remplir ces informations t’aidera à mieux comprendre ton état de santé et à en parler plus facilement avec ton médecin.</p>
      </div>
    </div>
  );
}
...
function Frame6077() {
  return (
    <div className="absolute bg-[#fffffe] box-border content-stretch flex flex-col gap-[13px] items-start justify-start p-[18px] rounded-[20px] top-[626px] translate-x-[-50%] w-[238px]" style={{ left: "calc(50% + 0.5px)" }}>
      <div aria-hidden="true" className="absolute border border-[#f0f0f0] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <Frame6191 />
    </div>
  );
...
function Plus2() {
  return (
    <div className="relative shrink-0 size-[30.5px]" data-name="plus">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 31 31">
        <g id="plus">
          <path d="M15.25 6.35417V24.1458" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" />
          <path d="M6.35417 15.25H24.1458" id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" />
        </g>
      </svg>
    </div>
  );
...
function Frame6108() {
  return (
    <div className="absolute bg-gradient-to-r box-border content-stretch flex from-[#a69bf8] gap-[6.1px] items-center justify-center left-[166px] p-[23.18px] rounded-[300px] size-[61px] to-[#0e7afe] top-[747px]">
      <Plus2 />
    </div>
  );
}

export default function HomepageNoLogToolTip() {
  return (
    <button className="bg-white block cursor-pointer overflow-clip relative rounded-[44px] size-full" data-name="Homepage_no log / Tool-tip">
      <div className="absolute bg-[rgba(0,0,0,0.58)] h-[852px] left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%] w-[393px]" />
      <Frame6077 />
      <Frame6108 />
      <BgLinear />
      <ProgressBar />
