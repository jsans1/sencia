...
import svgPaths from "./imports/svg-nxfmsfwucw";
...
import HomepageNoLogToolTip from "./components/HomepageNoLogToolTip";
...
interface AppState {
  ...
  moodEntries: number;
  selectedMood?: string;
  currentPage: 'home' | 'noLog' | 'article' | 'profile';
  showTooltip: boolean;
  currentArticle?: {
    image: string;
    title: string;
...
export default function App() {
  ...
  const handleMoodEntry = () => {
    if (state.currentPage === 'home') {
      // Navigate to no log page instead of incrementing mood entries
      setState(prev => ({ ...prev, currentPage: 'noLog' }));
    } else {
      // Show tooltip when on no log page
      setState(prev => ({ ...prev, showTooltip: true }));
    }
  };
  ...
  const handleOpenArticle = (article: { image: string; title: string; source: string; excerpt: string }, category: string) => {
    setState(prev => ({ 
      ...prev, 
      currentPage: 'article',
  ...
  const fakeArticles = {
    nutrition: [
      {
        image: "https://images.unsplash.com/photo-1670164747721-d3500ef757a6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxoZWFsdGh5JTIwZm9vZCUyMG51dHJpdGlvbnxlbnwxfHx8fDE3NTc4NTcyNzh8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
      ...
      {
        image: "https://images.unsplash.com/photo-1621525434111-87a99d170b0e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxibG9vZCUyMHByZXNzdXJlJTIwaGVhbHRofGVufDF8fHx8MTc1NzkyNTYxN3ww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    ...
    stress: [
      {
        image: "https://images.unsplash.com/photo-1635545999375-057ee4013deb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzdHJlc3MlMjBtYW5hZ2VtZW50JTIwd2VsbG5lc3N8ZW58MXx8fHwxNzU3OTI1NjA5fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
      ...
      {
        image: "https://images.unsplash.com/photo-1602713464923-b97ad228fcd0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtZWRpdGF0aW9uJTIwbWluZGZ1bG5lc3N8ZW58MXx8fHwxNzU3OTI1NjIwfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    ...
    health: [
      {
        image: "https://images.unsplash.com/photo-1530026454774-50cce722a1fb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxoZWFydCUyMGhlYWx0aCUyMG1lZGljYWx8ZW58MXx8fHwxNzU3OTI1NjI0fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
        title: "Prévenir les maladies cardiovasculaires",
        source: "Fédération Française de Cardiologie",
        excerpt: "Les habitudes de vie qui protègent votre cœur et réduisent les risques d'infarctus."
      },
      {
        image: "https://images.unsplash.com/photo-1634144646738-809a0f8897c4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxoZWFsdGh5JTIwbGlmZXN0eWxlJTIwZXhlcmNpc2V8ZW58MXx8fHwxNzU3OTI1NjI3fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
        title: "Sport et hypertension : recommandations",
        source: "Institut National du Sport",
        excerpt: "Comment adapter votre activité physique quand vous souffrez d'hypertension artérielle."
      }
    ]
  };
  ...
  const Frame6150 = () => (
    <div className="absolute content-stretch flex flex-col gap-3 items-start justify-center leading-[0] not-italic top-1/2 translate-x-[-50%] translate-y-[-50%] w-[241px]" style={{ left: "calc(50% - 30px)" }}>
      ...
      <div className="font-['SF_Pro_Display:Regular',_sans-serif] relative shrink-0 text-[#606060] text-[14px] w-full">
        <p className="leading-[1.2]">{state.moodEntries} remplissage /2, à toi de jouer !</p>
      </div>
    </div>
  );
  ...
  const HealthStatusCard = ({ icon, title, description, status, onClick }: {
          ...
          <div className="content-stretch flex flex-col gap-2 items-start justify-start relative shrink-0 w-full">
            <div className="content-stretch flex flex-col gap-1 items-start justify-start relative shrink-0">
              <div className="font-['SF_Pro_Display:Semibold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[24px] text-black text-center text-nowrap">
                <p className="leading-[1.2] whitespace-pre">Ton état de santé</p>
              </div>
            </div>
            <HealthStatusCard
              icon={<Frame6050 />}
      ...
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-col gap-4 items-start justify-start px-5 py-4 relative w-full">
          <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
            <div className="font-['SF_Pro_Display:Semibold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[24px] text-black text-center text-nowrap">
              <p className="leading-[1.2] whitespace-pre">Your Vitals</p>
            </div>
  ...
  const CarePlanInsight = ({ insightNumber, title, description, articles, category }: {
    ...
    title: string;
    description: string;
    articles: Array<{ image: string; title: string; source: string; excerpt: string }>;
    category: string;
  }) => (
      ...
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-col gap-4 items-start justify-start px-5 py-4 relative w-full">
          ...
          <CarePlanInsight
            ...
            description="You're improving this month, HLoris! Your symptoms were overall less painful as February this year."
  ...
  const BottomNavigation = () => {
    const navItems = [
      { id: 'home', label: 'Home', icon: svgPaths.p3039c600, active: true },
      { id: 'explore', label: 'Explore', icon: svgPaths.pace200, active: false },
      { id: 'care', label: 'Care', icon: svgPaths.p3ee62280, active: false },
      { id: 'profile', label: 'Loris', icon: svgPaths.p82039c0, active: false }
    ];
        ...
        <div className="box-border content-stretch flex h-[120px] items-start justify-between overflow-clip pb-[26px] pt-[15px] px-7 relative w-[393px]">
          <div className="content-stretch flex gap-6 items-center justify-start relative shrink-0">
            ...
            <button
              ...
              className={`content-stretch flex flex-col gap-[7px] items-center justify-center relative shrink-0 w-[45px] transition-colors ${
                state.activeTab === 'home' ? 'opacity-100' : 'opacity-60 hover:opacity-80'
              }`}
            >
                ...
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
                  <g>
                    <path 
                      ...
                      stroke={state.activeTab === 'home' ? "black" : "#A19F9E"} 
                      strokeLinecap="round" 
                      strokeLinejoin="round" 
                      strokeWidth="2" 
                    />
                    <path d="M9 22V12H15V22" stroke={state.activeTab === 'home' ? "black" : "#A19F9E"} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                  </g>
                </svg>
              </div>
              <div className={`font-['SF_Pro_Display:${state.activeTab === 'home' ? 'Medium' : 'Regular'}',_sans-serif] leading-[0] not-italic relative shrink-0 text-[14px] text-nowrap ${
                state.activeTab === 'home' ? 'text-black' : 'text-[#a19f9e]'
              }`}>
            ...
            <button
              ...
              className={`content-stretch flex flex-col gap-[7px] items-center justify-center relative shrink-0 w-[45px] transition-colors ${
                state.activeTab === 'explore' ? 'opacity-100' : 'opacity-60 hover:opacity-80'
              }`}
            >
              <div className="relative shrink-0 size-6">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
                  <g>
                    <path 
                      d={svgPaths.pace200} 
                      stroke={state.activeTab === 'explore' ? "black" : "#A19F9E"} 
                      strokeLinecap="round" 
                      strokeLinejoin="round" 
                      strokeWidth="2" 
                    />
                    <path d={svgPaths.p3dd108f1} stroke={state.activeTab === 'explore' ? "black" : "#A19F9E"} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                  </g>
                </svg>
              </div>
              <div className={`font-['SF_Pro_Display:${state.activeTab === 'explore' ? 'Medium' : 'Regular'}',_sans-serif] leading-[0] not-italic relative shrink-0 text-[14px] text-nowrap ${
                state.activeTab === 'explore' ? 'text-black' : 'text-[#a19f9e]'
              }`}>
            ...
            <button
              ...
              className={`content-stretch flex flex-col gap-[7px] items-center justify-center relative shrink-0 w-[45px] transition-colors ${
                state.activeTab === 'care' ? 'opacity-100' : 'opacity-60 hover:opacity-80'
              }`}
            >
              <div className="relative shrink-0 size-6">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
                  <g>
                    <path 
                      ...
                      stroke={state.activeTab === 'care' ? "black" : "#A19F9E"} 
                      strokeLinecap="round" 
                      strokeLinejoin="round" 
                      strokeWidth="2" 
                    />
              ...
              <div className={`font-['SF_Pro_Display:${state.activeTab === 'care' ? 'Medium' : 'Regular'}',_sans-serif] leading-[0] not-italic relative shrink-0 text-[14px] text-nowrap ${
                state.activeTab === 'care' ? 'text-black' : 'text-[#a19f9e]'
              }`}>
            ...
            <button
              ...
              className={`content-stretch flex flex-col gap-[7px] items-center justify-center relative shrink-0 w-[45px] transition-colors ${
                state.activeTab === 'profile' ? 'opacity-100' : 'opacity-60 hover:opacity-80'
              }`}
            >
              <div className="relative shrink-0 size-6">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
                  <g>
                    <path 
                      d={svgPaths.p82039c0} 
                      stroke={state.activeTab === 'profile' ? "black" : "#A19F9E"} 
                      strokeLinecap="round" 
                      strokeLinejoin="round" 
                      strokeWidth="2" 
                    />
                    <path d={svgPaths.p2c19cb00} stroke={state.activeTab === 'profile' ? "black" : "#A19F9E"} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                  </g>
                </svg>
              </div>
              <div className={`font-['SF_Pro_Display:${state.activeTab === 'profile' ? 'Medium' : 'Regular'}',_sans-serif] leading-[0] not-italic relative shrink-0 text-[14px] text-nowrap ${
                state.activeTab === 'profile' ? 'text-black' : 'text-[#a19f9e]'
              }`}>
  ...
  if (state.currentPage === 'noLog') {
    return (
      <>
        <HomepageNoLog 
          onPlusClick={handleMoodEntry}
          onBackClick={handleBackToHome}
        />
        {state.showTooltip && (
          <HomepageNoLogToolTip onClose={handleCloseTooltip} />
        )}
      </>
    );
  }

  if (state.currentPage === 'article' && state.currentArticle) {
    return (
      <ArticleView 
  ...
  if (state.currentPage === 'profile') {
    return (
      <Profil onBack={handleBackFromProfile} />
    );
  }
  ...
  return (
    <div className="bg-white flex flex-col min-h-screen overflow-hidden relative w-full max-w-[393px] mx-auto rounded-[44px]" data-name="Homepage">
      ...
      <div className="flex-1 overflow-y-auto relative">
        ...
        {/* Main content */}
        <div className="pt-[100px] pb-[140px]"> {/* Padding for progress bar and bottom nav */}
          {/* Greeting and mood widget */}
          <div className="px-5 mb-6">
            <div className="mb-5">
              <div className="font-['SF_Pro_Display:Medium',_sans-serif] leading-[0] not-italic text-[24px] text-black">
                <p className="leading-[1.1]">Bonjour, Loris !</p>
              </div>
            </div>
            <WidgetSencia />
